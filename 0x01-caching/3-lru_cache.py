...
class LRUCache(BaseCaching):
    ...
    def __init__(self):
        """Initialize the LRUCache instance and inherit properties from BaseCaching."""
        super().__init__()
        self.usedKeys = []
    ...
    def put(self, key, item):
        ...
        specified by BaseCaching.MAX_ITEMS, discard the least recently used item
        (LRU algorithm) and print the discarded key.
        """
